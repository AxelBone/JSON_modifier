...
if data:
    ...
    modified_data = extracted_data.copy()
    ...
    for i, annotation in enumerate(modified_data + st.session_state.new_annotations):
    ...
    if st.button("Add New Annotation"):
        new_annotation = {
            "sentence": "",
            "concerned_person": "",
            "hpoAnnotations": [{"hpoId": "", "hpoName": ""}]
        }
        st.session_state.new_annotations.append(new_annotation)
        st.rerun()
    ...
    final_data = {
        "annotations": modified_data + st.session_state.new_annotations,
