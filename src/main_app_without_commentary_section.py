...
st.text("This app will help you annotate simulated Electronic Health Records. You can modify each entry or add new sections.")
...
if data:
    ...
    # Prepare final data without commentary section
    final_data = {
